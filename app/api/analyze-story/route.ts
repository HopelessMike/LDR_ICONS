...
const validIcons = [
  ...
  "circle_dot", "square", "triangle", "hexagon", "accessibility", "activity", "alarm", "ambulance", "amphora", "aperture", "armchair", "axes", "banana", "barrel", "banknote", "bath", "battery_charging", "bed", "beef", "beer", "bell", "binoculars", "biohazard", "bitcoin", "biceps", "bone", "bottle", "bow", "brain_circuit", "box", "brush", "bubbles", "cake", "cake_slice", "calculator", "candy", "candy_cane", "taxi", "carrot", "castle", "cctv", "chart", "chef", "cherry", "church", "cigarette", "cigarette_off", "parking", "power_circle", "citrus", "clapperboard", "clipboard", "cloud", "drizzle", "cloud_moon", "cloud_sun", "clover", "cog", "cookie", "pot", "croissant", "disc", "dice", "drama", "dribbble", "drum", "drumstick", "dumbbell", "ear", "ear_off", "earth", "eclipse_icon", "egg", "fried_egg", "eraser", "euro", "expand", "eye_closed", "eye_off", "factory", "ferris_wheel", "fire_extinguisher", "flag", "flame_kindling", "flashlight", "flask", "flower2", "footprints", "gamepad_alt", "glass_water", "grape", "guitar", "ham", "hamburger", "hand", "fist", "metal", "handbag", "handshake_icon", "hat_glasses", "haze", "heart_crack", "hospital", "house_icon", "ice_cream", "kayak", "lamp", "life_buoy", "map_pinned", "martini", "megaphone_icon", "message_heart", "mic_vocal", "milk", "minimize", "mouse", "origami", "package_open", "panda", "paperclip", "party", "piano", "pi", "pickaxe", "piggy_bank", "pizza", "popcorn", "pyramid", "rat", "radar", "radiation", "radio_tower", "recycle", "rewind", "rose_icon", "sailboat", "salad", "sandwich", "scale", "ship_wheel", "shirt", "shopping_cart", "shovel", "shower", "shrimp", "shuffle", "siren", "snail", "sofa", "soup", "speech", "sprout", "squirrel", "swords", "tag", "tent", "test_tube", "thumbs_down", "ticket", "toilet", "tractor", "traffic_cone", "train_front", "trash", "tree_alt", "turtle_alt", "tv", "utensils", "venus_mars", "volleyball", "wallet_alt", "wand_sparkles", "watch", "wifi_alt", "wine_alt"
]
